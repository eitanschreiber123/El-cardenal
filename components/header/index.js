...
class Menu extends Component{constructor(props){super(props);
...
class Burger extends Component{constructor(props){super(props);
  }render(){return(<StyledBurger open={this.props.open}onClick={()=>this.props.setOpen(!this.props.open)}>
      <div />
      <div />
      <div />
    </StyledBurger>)}}
export default withTranslation('header')(class Header extends Component{constructor(props){super(props);
    this.state={active:`en`,open:false,w:``}}
  static async getInitialProps(ctx) {return{namespacesRequired:['header'],func}}
