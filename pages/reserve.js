              ...
              <div className="dates">
                  ...
                  <section>
                    ...
                    <section className="calendar">
                      <header className="header">
                        <div className="month-display row">{test.format("MMMM YYYY") != this.state.firstMonth.format("MMMM YYYY") ? <GoArrowLeft onClick={this.firstPrevious}/> : moment().format("MMMM YYYY") != this.state.firstMonth.format("MMMM YYYY") ? <GoArrowLeft onClick={this.firstPrevious}/> : null}<span className="month-label">{this.state.firstMonth.format("MMMM YYYY")}</span><GoArrowRight onClick={this.firstNext}/></div>
                ...
                <div>
                  ...
                  <section>
                    ...
                    <section className="calendar">
                      <header className="header">
                        <div className="month-display row">{test.format("MMMM YYYY") != this.state.secondMonth.format("MMMM YYYY") ? <GoArrowLeft onClick={this.secondPrevious}/> : moment().format("MMMM YYYY") != this.state.secondMonth.format("MMMM YYYY") ? <GoArrowLeft onClick={this.secondPrevious}/> : null}<span className="month-label">{this.state.secondMonth.format("MMMM YYYY")}</span><GoArrowRight onClick={this.secondNext}/></div>
                        <div className="row day-names">
                            <span className="day">{this.props.t("day_1")}</span>
                            <span className="day">{this.props.t("day_2")}</span>
                            <span className="day">{this.props.t("day_3")}</span>
