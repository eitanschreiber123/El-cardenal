...
const Wrapper=styled.div`font-family:Playfair Display;main>div:first-of-type{display:flex;flex-direction:column;align-items:center;margin-bottom:50px;}main>div:last-of-type>div:last-of-type{display:grid;grid-template-columns:repeat(4,235px);}main>div:last-of-type{display:flex;flex-direction:column;align-items:center;}main>div a>button{width:261px;height:40px;background-color:white;border:1px solid black;}main>div a>button:hover{background-color:rgb(97,26,30);border:1px solid white;}a{color:black;}main>div:last-of-type>div p,main>div:last-of-type>div h1{font-size:14px;font-weight:400;}main{align-items:flex-end;}.award{grid-template-columns:repeat(2,200px);grid-gap:50px 40%;}@media(max-width:1140px){main{align-items:center;}}@media(max-width:970px){main>div:last-of-type>div:last-of-type{grid-template-columns:repeat(3,235px)}}@media(max-width:700px){main>div:last-of-type>div:last-of-type{grid-template-columns:repeat(2,235px)}}@media(max-width:600px){main>div:last-of-type>div:last-of-type{grid-template-columns:repeat(1,235px)}}@media(max-width:700px){.award{grid-template-columns:repeat(1,200px);}}`
export default withTranslation('common')(class HomePage extends Component{constructor(props){super(props);
    this.state={w:``}}
