...
const Wrapper=styled.div`font-family:Playfair Display;main{height:100vh;}main>section{background-color:white;display:flex;flex-direction:column;align-items:center;padding:0 20px;}main>section>div:first-of-type{display:flex;flex-direction:row;margin-bottom:100px;}main>section>div:first-of-type button{padding:10px;background-color:black;color:white;width:fit-content;border:none;}.contact-form{display:flex;flex-direction:column;align-items:flex-end;}.ma{width:310px;}@media(max-width: 850px){main>section>div:first-of-type{flex-direction: column;width: 100%;align-items:flex-start;}main{height:150vh;}main>section{width:90%}.ma{width:100%;}}`
    ...
    return(<Wrapper style={{width:this.state.w}}>
        ...
        <main style={{width:this.state.w,margin:0,position:`relative`,top:`50px`,display:`flex`,flexDirection:`column`,alignItems:`center`,justifyContent:`center`,zIndex:1,backgroundImage:`url(/contact/background_1.png)`,backgroundPosition:`center`,backgroundSize:`cover`,backgroundRepeat:`no-repeat`}}>
          <section>
            ...
            <hr style={{width:`10px`}}/>
            <div>
              <div className="ma" style={{height:`217px`,zIndex:0,marginRight:`40px`}}><MyMap style={{zIndex:0}}center={[-4.0081308,-79.2401756]}zoom={15}markers={[{position:[-4.0081308,-79.2401756]}]}/></div>
