...
const Wrapper = styled.div`font-family:Playfair Display;main>section{background-color:white;display:flex;flex-direction:column;align-items:center;padding:0px 20px;width:90vw;padding-bottom:100px;}main>section>div:first-of-type{display:flex;flex-direction:row;}main>section>div:first-of-type>div{margin:0 50px;width:200px;height:200px;}`
        ...
        <main style={{width:`100%`,margin:0,position:`relative`,top:`7vh`,paddingTop:`90px`,display:`flex`,flexDirection:`column`,alignItems:`center`,zIndex:1,backgroundImage:`url(/events/background_1.png)`,backgroundPosition:`center`,backgroundSize:`cover`,backgroundRepeat:`no-repeat`}}>
          <section>
            ...
            <div>
              ...
              <div style={{background:`center / cover no-repeat url(/location/hotel.jpg)`}}></div>
            </div>
